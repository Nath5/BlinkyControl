...
class BlinkyFrameBuilderTest {
	...
	public void shouldBeAbleToCreateFrameWhereAllLightsAreASingleColor() {
		...
		frame.lights.eachWithIndex {Color light, int lightNumber ->
			assertEquals("Light ${lightNumber} should have been ${Color.BLUE}: ", light, Color.BLUE)
		}
	}
	...
	public void shouldBeAbleToSetASpecificLightToAColor() {
		...
		assertEquals("Light was not correctly colored: ", EXPECTED_COLOR, frame.getLight(EXPECTED_LIGHT))
	}
	...
	public	void shouldBeAbleToSetVariousLightsToVariousColorsAtOnce(){
		...
		assertEquals("Light ${FIRST_LIGHT} was not correctly colored: ", FIRST_LIGHT_COLOR, frame.getColorOfLight(FIRST_LIGHT))
		assertEquals("Light ${SECOND_LIGHT} was not correctly colored: ", SECOND_LIGHT_COLOR, frame.getColorOfLight(SECOND_LIGHT))
	}
